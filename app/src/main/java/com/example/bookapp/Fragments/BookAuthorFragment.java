...
public class BookAuthorFragment extends Fragment implements Callback<VolumesResponse>{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_book_author, container, false);
    }
    ...
    private void getBooks()
    {
        ...
        {
            Toast.makeText(getActivity(),"Unesite naziv autora", Toast.LENGTH_SHORT).show();
            return;
        }

        String final_query = search_query.replace(" ","+");

        ApiManager.getInstance().service().getEveryVolumesOfAuthor("inauthor:"+final_query).enqueue(this);
    }

    private boolean Read_network_state(BookAuthorFragment context)
    {
